...
#  sim_ver1.cgi v 3.2.a
#  Status: in test
#  This is a module of the online radioamateur examination program
#  "SimEx Radio", created for YO6KXP ham-club located in Sacele, ROMANIA
#  Made in Romania

# ch 3.2.a charset=utf-8 in html
...
#CUSTOM 
my @database=("db_tech1","db_ntsm","db_op1","db_legis1","db_sanctiuni");       #set the name of used databases and their order
...
my @clusterCount = (20,10,8,25); #CUSTOM: counts per cluster-chapter - not a nice implementation
my @mincount=(15,7,6,20); #minimum number of good answers per clustered chapter
...
{ $slurp_userfile[$user_account*7+6]="1\n";} #CUSTOM - 1 is latest achieved class
