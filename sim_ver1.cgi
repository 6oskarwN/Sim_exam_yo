...
close (transactionFILE) or dienice("verERR07",1,\"$! $^E $?");
...
close(userFILE) or dienice("verERR07",1,\"$! $^E $?"); 
...
#CUSTOM 
my @database=("db_tech1","db_ntsm","db_op1","db_legis1");       #set the name of used databases and their order
...
open(HLRfile,"+< hlr/$trid_login_hlrname") or dienice("verERR07",1,\"$! $^E $?"); #open
