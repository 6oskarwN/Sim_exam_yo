...
# In distributia pe CD sau download pe examyo.scienceontheweb.net trebuie sa gasiti o copie a licentei GNU GPL, de asemenea si versiunea 
...
# ch 3.0.d devel version, try to allow filename with funky chars /- at beginning
...
print qq!<form action="http://localhost/cgi-bin/sim_ver1.cgi" method="get">\n!; #CUSTOM
